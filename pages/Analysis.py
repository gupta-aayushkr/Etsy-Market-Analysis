...
ax2.scatter(df["Daily Views"], df["Listing Age (Days)"])
...
fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(nrows=2, ncols=2, figsize=(8, 8))
ax1.scatter(df["Est. Sales"], df["Price"])
ax1.set_xlabel("Est. Sales")
ax1.set_ylabel("Price")
ax1.set_title("Est. Sales vs. Price")

ax2.scatter(df["Est. Sales"], df["Total Views"])
...
fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(nrows=2, ncols=2, figsize=(8, 8))
ax1.scatter(df["Price"], df["Listing Age (Days)"])

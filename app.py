...
ax2.set_ylabel("Daily Views")
ax2.set_title("Daily Views vs. Daily Views")
...
ax1.set_ylabel("Est. Sales")
ax1.set_title("Est. Sales vs. Est. Sales")

ax2.scatter(df["Est. Sales"], df["Est. Sales"])
ax2.set_xlabel("Est. Sales")
ax2.set_ylabel("Est. Sales")
ax2.set_title("Est. Sales vs. Est. Sales")
